...
const Hero = () => {
  ...
  return (
    <>
      ...
      <section
        id="home"
        className="relative z-10 overflow-hidden pt-[120px] pb-16 md:pt-[150px] md:pb-[120px] xl:pt-[180px] xl:pb-[160px] 2xl:pt-[210px] 3xl:pb-[200px]"
        style={{
          backgroundImage: 'url(/images/hero/floaty-bg.jpg)',
            ...
            <div className="w-full px-4">
              ...
              >
                ...
                {/* <p className="mb-12 text-base font-medium !leading-relaxed text-body-color dark:text-white dark:opacity-90 sm:text-lg md:text-xl">
                  A blurb expressing something about Rainbow FL.O.A.T.Y.
                </p> */}
                <br /><br />
                <div className="flex flex-col items-center justify-center space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0">
                  ...
                  >
                    Subscribe<br /><sub>to our newsletter</sub>
                  </button>
                  <button
                    className="rounded-md bg-primary py-4 px-8 text-base font-semibold text-white duration-300 ease-in-out hover:bg-primary/80"
                  >
